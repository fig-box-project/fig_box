...
class Module:
    ...
    def update_status(self):
        try:
            ...
            print("may be the module_manager unexcited")
    ...
    def download(self, store: str):
        ...
        # 解压
        Tool.unzip(zip_path, "app/modules/", self.name)
        # 使用
        self.use()
    ...
    def uninstall(self):
        ...
        shutil.rmtree("app/modules/" + self.name)
...
def local_ls():
    mod_list = os.listdir("app/modules")
    ...
    def store_ls(self, store_address: str):
        ...
        if store_address in self.data:
            ...
            try:
                ...
                insmodes_list = os.listdir("app/modules")
                rt = []
                for i in j:
                    i = i["name"]
